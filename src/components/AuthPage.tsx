  ...
  const handleLogin = async () => {
    try {
      ...
      const { error } = await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: { 
          // Redirect back to the current origin after successful Google login
      ...
      alert("Authentication failed. Please ensure your Supabase redirect URLs are configured correctly.");
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#050505] p-6">
      <div className="relative group max-w-md w-full">
        ...
        <div className="relative bg-[#0f0f0f] border border-white/10 p-8 rounded-3xl text-center shadow-2xl">
          ...
          <p className="text-gray-400 mb-8 text-sm">Access 150+ agentic tools. Start with 5 free credits.</p>
