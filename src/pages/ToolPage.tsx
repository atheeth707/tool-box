...
export default function ToolPage() {
  ...
  if (!tool) return <div className="text-center py-20 px-4">Tool not found</div>;
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 md:space-y-10 px-4 sm:px-6 lg:px-8 py-4">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 sm:p-8 md:p-14 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-sm text-center relative overflow-hidden">
        ...
        <h1 className="text-2xl sm:text-3xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-4">
          {tool.name}
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-4 mt-8">
          ...
          <button 
            onClick={handleShare} 
            className="w-full sm:w-auto flex items-center justify-center text-sm font-semibold text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400 bg-gray-100 hover:bg-blue-50 dark:bg-gray-700 dark:hover:bg-gray-600 px-6 py-2.5 rounded-full transition-all"
          >
