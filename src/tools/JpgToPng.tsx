      ...
      {!image ? (
        <label className="flex flex-col items-center justify-center w-full h-80 border-2 border-blue-300 border-dashed rounded-3xl cursor-pointer bg-blue-50/50 dark:bg-blue-900/10 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all group">
          <div className="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            <p className="mb-2 text-lg text-gray-700 dark:text-gray-300"><span className="font-bold text-blue-600 dark:text-blue-400">Upload JPG Image</span></p>
            <p className="text-sm text-gray-500">Max file size: 5MB</p>
          </div>
          <input type="file" className="hidden" accept="image/jpeg, image/jpg" onChange={handleImageUpload} />
        </label>
      ) : (
        <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700">
          <div className="flex justify-center items-center mb-8 space-x-4">
            <span className="px-4 py-2 bg-gray-100 dark:bg-gray-700 rounded-lg font-bold text-gray-600 dark:text-gray-300">JPG</span>
            <span className="text-gray-400">→</span>
            <span className="px-4 py-2 bg-blue-100 dark:bg-blue-900/50 rounded-lg font-bold text-blue-600 dark:text-blue-400">PNG</span>
          </div>
